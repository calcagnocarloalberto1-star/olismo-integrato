...
REGOLA: se l'utente specifica "Tx con ala y" modula la risposta integrando le qualità dell'ala. L'ala NON è calcolabile se nei test i due numeri adiacenti pareggiano (es. punteggio uguale su 9 e 2 per un T1).
...
REGOLA TEST: se la risposta più alta del test 9 Frutti assegna meno di 10 item, l'enneatipo NON è certo (serve genogramma); se ci sono due o più valori massimi (es. 13 a T8 e 13 a T9) idem. Quando l'utente specifica il sottotipo, integra le qualità nella risposta.
