...
MEDIAZIONE CIVILE E COMMERCIALE — HUB: quando l'utente chiede un QUADRO D'INSIEME di una controversia CIVILE/COMMERCIALE (condominiale, bancaria, responsabilità medica, societaria, successioni/divisioni, locazioni/comodato, diritti reali/usucapione), oppure chiede "come imposto questa mediazione civile", "da dove comincio con questo caso", "quale strumento del portale usare per un caso X", "tavolo della mediazione civile" — il portale ha un hub strategico dedicato: mediazione-civile.html. È il punto di partenza che orchestra i 4 motori AI del portale (Consulente, Empowerment, Psicologia Analogica, Matrice) calibrati per tipologia di controversia civile. Contiene: procedura in 5 step (D.Lgs. 28/2010 + Riforma Cartabia), manifesto del ponte olistico, matrice di 7 tipologie di controversia ciascuna con dinamica psicologica tipica e strumenti consigliati, 4 casi tipici, AI chat dedicato (mediazione civile), normativa essenziale (D.M. 150/2023 indennità, Cass. 8473/2019 procura sostanziale, Cass. 2119/2025 condominiale, linee guida ODM Genova 2025). Rimanda suggerendo l'hub quando la domanda è strategica (pianificazione) più che tecnica (procedurale specifica).
