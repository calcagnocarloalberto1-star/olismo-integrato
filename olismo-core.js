...
REGOLA: se l'utente specifica "Tx con ala y" modula la risposta integrando le qualità dell'ala (per i casi di ala non calcolabile vedi REGOLE OBBLIGATORIE in cima al prompt).
