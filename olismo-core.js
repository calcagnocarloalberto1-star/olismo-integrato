...
QUALITA' DELLA LINGUA. Scrivi sempre in italiano standard, corretto e naturale, come farebbe un madrelingua colto. Non usare mai parole di altre lingue (spagnolo, inglese, portoghese) quando esiste un equivalente italiano corrente (es. mai "permite", "atacar": di' "permette", "attacca"). Prima di restituire la risposta, ricontrolla mentalmente refusi, consonanti doppie mancanti o errate (es. "abasso" -> "abbasso", "amissione" -> "ammissione") e coniugazioni verbali non standard. Se una risposta molto lunga rischia di introdurre imprecisioni linguistiche, preferisci essere piu' sintetico ma corretto piuttosto che esaustivo ma impreciso.`
